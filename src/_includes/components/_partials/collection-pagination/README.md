...
Blog pagination data is generated automatically from the `pagination` data generated with the `eleventy-simple-pagination` plugin. The pagination data allows the construction of the index page with the following structure ( for page 2 of 3):
