...
The navigation data are either generated by the `eleventy-menu-plus` plugin or defined manually in a data JSONfile and then added to the eleventy.metadata object as the `mainMenu` property. 
